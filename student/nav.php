            ...
            <?php
                    ...
                    if(isset($_SESSION['userName'])){?>
                        <ul class="nav navbar-nav navbar-right">
                          ...
                          <li style="margin-top: -1px; color: white;"><a style="text-decoration: none;color: white;" href="student-profile.php"><?=$_SESSION['activeUser']['firstname'];?></a></li>
                            <li><a href="index.php"><i class="fa fa-home"></i> HOME</a></li>
                            <li><a href="boks.php"><i class="fa fa-book"></i> BOOKS</a></li>
                            <li><a href="student_logOut.php"><span class="glyphicon glyphicon-log-out">Log-Out</span></a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="index.php"><i class="fa fa-home"></i> HOME</a></li>
                            <li><a href="boks.php"><i class="fa fa-book"></i> BOOKS</a></li>
                            <li><a href="student_login.php"><span class="glyphicon glyphicon-log-in"> Student_Login</span></a></li>
                            <li><a href="feedback.php"><i class="fa fa-comment"></i> FeedBack</a></li>
            </ul>
