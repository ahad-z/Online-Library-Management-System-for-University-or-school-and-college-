...
<html>
	...
	<body>
		...
		if(isset($_SESSION['reqMesage'])){
			...
			echo '<div style= "margin-left:500px; width:500px;text-align:center;" class="alert alert-info" >' .  $_SESSION['reqMesage'] . "  "  . '<a  style= "text-decoration: none; color: gray;" href="request_for_returnDate.php">Here</a>' .'</div>';
...
<div class="search">
	<form action="" method="POST" class="navbar-form">
		...
		<br><br>
		<button class="btn btn-primary" style="background-color:#34a29b;" name="requst_book">Request For Book</button>
