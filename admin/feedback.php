				...
				<?php
					...
					<div class="col-sm-4 col-sm-offset-4">
						<div class="card-title">
							<?php if ($feed_row['type'] == 'admin'): ?>

							<h5 style="margin-bottom: 10px; color: gray; font-size: 25px;"> <span class="badge"><?=$feed_row['type'];?></span></h5>

							<?php else: ?>
							<h5 style="margin-bottom: 10px; color: gray; font-size: 25px;"><?=$feed_row['name'];?></h5>
							<?php endif ?>
