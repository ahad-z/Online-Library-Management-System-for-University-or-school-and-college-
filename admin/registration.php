                ...
                <div class="box2">  
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="login">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="contract" placeholder="018XXXX" value="<?php if(isset($_SESSION['old']['contract'])){
                                echo $_SESSION['old']['contract'];
                                }?>">
                                <label class="error">
                                    <?php
                                    if(isset($_SESSION['validation']['contract']))
                                    {
                                    echo $_SESSION['validation']['contract'];
                                    }
                                    ?>
                                </label>
                                <label class="error">
                                    <?php
                                    if(isset($_SESSION['validation']['error_contract']))
                                    {
                                    echo $_SESSION['validation']['error_contract'];
                                    }
                                    ?>
                                </label>
                            </div>
